...
// Temporary mock data for the upcoming plants that need care; swap with real data later/real upcoming tasks created from user plants
const UPCOMING: Task[] = [
...
export default function Home() {
  ...
  return (
    <View style={styles.container}>
      {/* Top image header (place file at: /assets/images/home-vines.png) */}
      <Image
        source={require("../assets/images/home-vines.png")}
        style={styles.hero}
        resizeMode="contain"
        accessible
      ...
      <ScrollView contentContainerStyle={styles.contentScroll} showsVerticalScrollIndicator={false}>
        ...
        {/* Featured plant (example) REPLACE THIS LATER WITH USER PHOTOS AND REPLACE TITLE WITH USER PLANT NAMES */}
        <PlantCard
        ...
        <View style={styles.upcoming}>
          ...
          <FlatList
            ...
            scrollEnabled={false} // page ScrollView handles vertical scrolling
          />
        </View>
...
{/* Learning tiles + CTA grid (2 per row, wraps to next row) */}
        <Text style={styles.sectionTitle}>Learn</Text>
        <View style={styles.tilesGrid}>
                    {/* Intro to Sprouts (This is a tab that introduces the app)*/}
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  // Used by ScrollView to lay out content
  contentScroll: {
    width: "100%",
    maxWidth: 720,
    alignSelf: "center",
