    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.body}>Welcome to our brand-new app: Sprouts!
            ...
            you can save and set up reminders for your very own personal plants and their care routines. Peruse the app to find beginner tips, advanced care techniques, and everything in between.
